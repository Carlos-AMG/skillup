...
const generateOfferDetailsHTML = (offerDetails) => {
  ...
  `;
    ...
    const expressInterestForm = userType === "students" ? `
    ...
    const companyActions = userType === "companies" ? `
      <div class="py-2">
        <a href="/delete-offer/${currentFilterJobCourse}/${offerDetails.id}" class="px-5 bg-red-500 text-white uppercase hover:bg-red-700 font-bold py-3 cursor-pointer rounded-md">Delete Offer</a>
        <a href="/update-offer/${currentFilterJobCourse}/${offerDetails.id}" class="px-5 bg-yellow-500 text-white uppercase hover:bg-yellow-700 font-bold py-3 cursor-pointer rounded-md">Update Offer</a>
        <a href="/see-students/${currentFilterJobCourse}/${offerDetails.id}" class="px-5 bg-blue-500 text-white uppercase hover:bg-blue-700 font-bold py-3 cursor-pointer rounded-md">See Interested Students</a>
      </div>
    ` : "";
